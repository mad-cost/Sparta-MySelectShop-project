...
class ProductServiceIntegrationTest {
  ...
  // @TestInstance: 각각의 클래스들이 아래의 필드를 공유한다
  User user;
  ...
  void test1() {
    ...
    // @TestInstance를 사용여 필드를 정의 했기 때문에 다른 필드에서도 user를 공유한다
    ...
    createdProduct = product; // createdProduct 필드 공유
  }
  ...
  void test2() {
    ...
    // when
    ProductResponseDto product = productService.updateProduct(productId, requestDto); // 희망 최저가 변경
