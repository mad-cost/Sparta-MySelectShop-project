...
@WebMvcTest(
        // UserController와 ProductController를 테스트 한다
        controllers = {UserController.class, ProductController.class},
        excludeFilters = {
                @ComponentScan.Filter( // WebSecurityConfig를 제외시킨다
...
class UserProductMvcTest {
  ...
  void test2() throws Exception {
    ...
    mvc.perform(post("/api/user/signup")
            ...
            .andExpect(view().name("redirect:/api/user/login-page")) // 회원 가입 성공시 로그인 페이지 반환
            .andDo(print());
  }
